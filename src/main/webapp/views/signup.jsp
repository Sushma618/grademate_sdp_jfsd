...
<body>
  ...
  <div class="wrapper">
    <!-- Success Message -->
    <div id="successContainer" class="success" style="display: none; color: green; margin-bottom: 20px;">
  ...
  <script>
    document.getElementById('signupForm').addEventListener('submit', function (e) {
      ...
      if (errors.length > 0) {
        ...
        e.preventDefault(); // Prevent default submission for demo purposes
        errorContainer.innerHTML = ""; // Clear errors
        successContainer.style.display = "block"; // Show success message
        setTimeout(() => {
          window.location.href = "/"; // Redirect to login after 2 seconds
        }, 2000);
      }
    });
  </script>
